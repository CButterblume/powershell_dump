...
.DESCRIPTION
This script sets two DNS Records for each office web apps server.
One for the server itself and one for the office web apps server pool and the IP of the server.
...
Initialize-BLFunctions -AppName "MS_LYNC2013_WA_CFG_DNSRecords" -AppSource $Local:ScriptPath -Force:$Force -Uninstall:$Uninstall
